-- This file for building with the static version of libavro
-- which dimaically link it dependencies on the Windows

package = "avro"
version = "scm-1"

source = {
  url = "https://github.com/Asmoday/lua-avro/archive/master.zip",
  dir = "lua-avro-master",
}

description = {
   summary = "Lua bindings for Avro C library",
   homepage = "https://github.com/Asmoday/lua-avro",
   license = "MIT/X11"
}
